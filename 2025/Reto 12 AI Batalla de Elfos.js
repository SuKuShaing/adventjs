...
function elfBattle(elf1, elf2) {
    ...
    for (let i = 0; i < rounds; i++) {
        ...
        // Elf 1's action effects on Elf 2
        if (move1 === 'F') damageToElf2 = 2;
        else if (move1 === 'A' && move2 !== 'B') damageToElf2 = 1;

        // Elf 2's action effects on Elf 1
        if (move2 === 'F') damageToElf1 = 2;
        else if (move2 === 'A' && move1 !== 'B') damageToElf1 = 1;

        health1 -= damageToElf1;
        health2 -= damageToElf2;
...
console.log(elfBattle("AAFFFBBB", "ABBBBFFF"));
// → 1
