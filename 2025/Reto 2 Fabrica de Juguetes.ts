...
export function manufactureGifts(
    ...
    for (let i = 0; i < giftsToProduce.length ; i++) {
        if (typeof giftsToProduce[i].quantity === 'number') {
            if (giftsToProduce[i].quantity > 0) {
                for (let j = giftsToProduce[i].quantity - 1; j >= 0 ; j--) {
                    listaFinal.push(giftsToProduce[i].toy);
                }
            }
        }
    };
...
export const production1 = [
    { toy: "car", quantity: 3 },
    { toy: "doll", quantity: 1 },
    { toy: "ball", quantity: 2 },
];

export const result1 = manufactureGifts(production1);
console.log(result1);
// ['car', 'car', 'car', 'doll', 'ball', 'ball']
...
export const result2 = manufactureGifts(production2);
console.log(result2);
// ['puzzle']

export const production3 = [];
export const result3 = manufactureGifts(production3);
console.log(result3);
// []
