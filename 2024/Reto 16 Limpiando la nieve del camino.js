...
*/
function removeSnow(cadenaDeTexto) {
    let cadenaConMenosLetras = cadenaDeTexto;
    let previa = '';
    
    while (previa !== cadenaConMenosLetras) {
        previa = cadenaConMenosLetras;
        cadenaConMenosLetras = cadenaConMenosLetras.replace(/(.)\1/g, '');
    }

    console.log(cadenaConMenosLetras);
    return cadenaConMenosLetras;
}
